    ...
    switch (role.toLowerCase()) {
      ...
      case 'supervisor':
        cards = [
          ...
          //     icon: Icons.business,
          //     title: "عرض المراكز",
          //     onTap: () => context.pushNamed(Routes.viewCenters)),
          DashboardCard(
              icon: Icons.add_business,
              title: "إضافة موظفين",
              onTap: () => context.pushNamed(Routes.addEmployeeSupervisor)),
          DashboardCard(
              icon: Icons.business,
              title: "التقارير",
              onTap: () => context.pushNamed(Routes.viewReports)),
          DashboardCard(
              icon: Icons.add_business,
              title: "ادارة التطعيمات",
              onTap: () => context.pushNamed(Routes.addVaccination)),
          DashboardCard(
              icon: Icons.add_business,
              title: "إضافة وعرض المراكز",
              onTap: () => context.pushNamed(Routes.addCenter)),
        ];
        break;
      default:
        cards = [
          DashboardCard(
              icon: Icons.person,
              title: "الرئيسية",
              onTap: () => context.pushNamed(Routes.managerDashboard)),
        ];
        break;
    }
