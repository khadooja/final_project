...
// import 'package:new_project/features/vaccination/vaccine/presentation/CustomAppBar.dart';
...
//           ScaffoldMessenger.of(context)
//               .showSnackBar(SnackBar(content: Text('تمت إضافة التطعيم بنجاح')));
...
//         child: Scaffold(
//           appBar: CustomAppBar(title: 'إضافة تطعيم'),
...
//                             decoration:
//                                 InputDecoration(labelText: 'اسم التطعيم'))),
//                     SizedBox(width: 12),
//                     Expanded(
//                         child: TextField(
//                             controller: vaccineDescriptionController,
//                             decoration:
//                                 InputDecoration(labelText: 'وصف التطعيم'))),
//                   ],
//                 ),
//                 SizedBox(height: 12),
//                 Row(
...
//                                 decoration:
//                                     InputDecoration(labelText: 'أيام التأخير'),
