...
mixin _$LoginState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T data, String role) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(T data, String role)? success,
...
class _$SuccessImpl<T> implements Success<T> {
  const _$SuccessImpl(this.data, this.role);
  ...
  @override
  String toString() {
    return 'LoginState<$T>.success(data: $data, role: $role)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(data), role);
...
abstract class Success<T> implements LoginState<T> {
  const factory Success(final T data, final String role) = _$SuccessImpl<T>;
...
class _$PasswordVisibilityChangedImpl<T>
  ...
  @override
  String toString() {
    return 'LoginState<$T>.passwordVisibilityChanged()';
  }
